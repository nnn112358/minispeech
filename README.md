...
| | piper (VITS) | piper-plus | mini-jtts |
|---|---|---|---|
| 構成 | End2End | End2End | 2段階パイプライン (音響モデル + ボコーダ) |
| エンコーダ | Self-Attention  | Self-Attention  | Conv NetWork |
| デコーダ | HiFi-GAN | MB-iSTFT | SqueezeWave |
| 継続長 | VAE + Flow + MAS | VAE + Flow + MAS | Duration Predictor + 自己アライメント |
| G2P | espeak-ng | OpenJTalk  | OpenJTalk  |
| パラメータ数 | ~15.7M | ~19.6M |  4.45M〜11.01M |
| ライセンス | MIT  | MIT | MIT |
